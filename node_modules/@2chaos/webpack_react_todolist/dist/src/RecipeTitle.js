...
function TodoListItem(props) {
    var _useState = (0, _react.useState)("white"), _useState2 = _slicedToArray(_useState, 2), hover = _useState2[0], setHover = _useState2[1];
    var _useState3 = (0, _react.useState)(0), _useState4 = _slicedToArray(_useState3, 2), opstate = _useState4[0], setOp = _useState4[1];
    var _useState5 = (0, _react.useState)(0), _useState6 = _slicedToArray(_useState5, 2), _ = _useState6[0], setB = _useState6[1];
    ...
    }, props.content, props.button === 1 ? /*#__PURE__*/ _react["default"].createElement("buttton", null, "\xD7") : null), props.splitLine ? /*#__PURE__*/ _react["default"].createElement("hr", null) : null);
}
