...
function App() {
  ...
  var _e = (0, react_1.useState)(function () {
    ...
    pageNum = _e[0],
    setPageNum = _e[1];
  var _f = (0, react_1.useState)("bottom"),
    position = _f[0],
    setPosition = _f[1];
  var _g = (0, react_1.useState)("end"),
    align = _g[0],
    setAlign = _g[1];
    ...
    <article>
      ...
      <antd_1.Space>
        <antd_2.Input
          ...
          onKeyDown={function (e) {
            if (e.key === "Enter") {
              setTodo(
                __spreadArray(__spreadArray([], todo, true), [state], false)
              );
              updateState("");
            }
          }}
      ...
      <antd_3.List
        ...
        renderItem={function (item) {
          return <antd_3.List.Item>{item}</antd_3.List.Item>;
        }}
        pagination={{
          position: position,
          align: align,
